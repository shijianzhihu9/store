...
<div class="container-fluid">
	...
	<br><br>
	<form class="form-horizontal" action="<%=request.getContextPath()%>/admin/Salesperson_add" method="post">
		<div class="form-group">
			<label for="input_name" class="col-sm-1 control-label">用户名</label>
			<div class="col-sm-6">
				<input type="text" class="form-control" id="input_name" name="salespersonname" required="required" value="${u.salespersonname }" />
			</div>
		</div>
		<div class="form-group">
