...
public class UserDao {
    public void addUser(User user) throws SQLException {
        ...
        String sql = "insert into user(username,email,password,name,phone,address,isvalidate) values(?,?,?,?,?,?,?)";
        r.update(sql,user.getUsername(),user.getEmail(),user.getPassword(),user.getName(),user.getPhone(),user.getAddress(),user.isIsvalidate());
    }
